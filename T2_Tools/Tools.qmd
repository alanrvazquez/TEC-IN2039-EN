...
In this course, we will be working mostly with **pandas** for data manipulation and wrangling
...
1.  Open the following <a href="https://colab.research.google.com/drive/1xLoaOMharQmmasNApjm38jZcw-gtcxvm?usp=sharing" target="_blank">Google Colab</a> link: <https://colab.research.google.com/drive/1xLoaOMharQmmasNApjm38jZcw-gtcxvm?usp=sharing>
...
## Saving pandas dataframes into Excel

</br></br>

Finally, we can save the **pandas** objects into an Excel file using the function `.to_excel()` as follows.

```{python}
#| eval: true
#| echo: true

# mean_penguins_data.to_excel("mean_penguins_data.xlsx")
```

</br>

> Of course, remove the \# symbol before running the code. 
...
- **pandas** is a library that allows us to manipulate data in Python.
