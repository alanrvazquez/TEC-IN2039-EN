...
plt.figure(figsize=(8, 6))
sns.scatterplot(data=auto_data, x="weight", y="mpg", color="blue", label="Data")
sns.regplot(data=auto_data, x="weight", y="mpg", scatter=False, color="red", label="Linear Fit")
...
plt.figure(figsize=(8, 6))
sns.scatterplot(data=auto_data, x="weight", y="mpg", color="blue", label="Data")
sns.regplot(data=auto_data, x="weight", y="mpg", scatter=False, color="red", 
            line_kws={"linestyle": "-", "linewidth": 3}, label="Linear Fit")
...
# Suponiendo que 'mi_diagrama' es un DataFrame con columnas 'x' e 'y'
sns.lmplot(data=mi_diagrama, x="x", y="y", line_kws={"color": "red", "linestyle": "-", "linewidth": 2})
...
# Store the figure in grafica_modelo
grafica_modelo = fig

# Show the plot (optional, as you can show or save it later)
plt.show()
```
