...
import pandas as pd      # Equivalent to 'readxl' for reading Excel files
import seaborn as sns    # Equivalent to 'ggplot2' for plotting
import matplotlib.pyplot as plt  # For plotting (used alongside seaborn)
import numpy as np        # For data manipulation (similar to 'dplyr')
...
# Create the scatter plot with customized color, shape, and size
sns.scatterplot(data=auto_data, x="weight", y="mpg", color="blue", marker="x", s=100)
