...
3.  If needed, adapt the code to create a pie chart for the `island` variable in `penguin_data`.

## Part 2

1.  Ask ChatGPT or Gemini to create a pie chart using the prompt:

*You are an expert in data visualization using the libraries "matplotlib" and "seaborn" of the Python programming language. You want to visualize the proportions of three species of penguins using a pie chart. To construct the graph, use the "penguin_data" dataset. The variable "island" contains the categories of penguins. To enhance the graph, add the title "Proportion of Penguins" and use different colors for the categories of penguins.* 

3. Discuss the pie charts created by you and this prompt.
