...
::: {style="font-size: 65%;"}
You are an expert in data visualization using the libraries "matplotlib" and "seaborn" of the Python programming language. The goal is to visualize the proportions of three species of penguins using a pie chart. To achieve this goal, perform the following steps:
