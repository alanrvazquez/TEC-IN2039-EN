...
-   It is part of the collection of data science packages called **tidyverse**.
...
1.  [**Import:**]{style="color:darkblue;"} Bring raw data into R.
...
1.  [**Import:**]{style="color:darkblue;"} Bring raw data into R. (**readxl**)
2.  [**Tidy:**]{style="color:darkblue;"} Reshape into a consistent format. (**tidyr**)
3.  [**Transform:**]{style="color:darkblue;"} Create new variables and summaries. (**dplyr**)
4.  [**Visualize:**]{style="color:darkblue;"} Explore patterns visually.
5.  [**Model:**]{style="color:darkblue;"} Fit statistical or machine learning models.
6.  [**Communicate:**]{style="color:darkblue;"} Share insights clearly.
...
Here, we will discuss the more common ones:
