...
The `str.split()` function separates the contents of one column into multiple columns by splitting the text wherever a separator appears.

Consider the `Comment` column.
...
combined_column = (augmented_data
                .filter(["First_comment"], axis = 1)
                .str.cat(combined_data["Second_comment"], sep=": ")
                )
