...
import plotly.io as pio # Ensure figure displays in Quarto
pio.renderers.default = "iframe"  # Change to "notebook", "iframe", or "div"
...
fig = px.line(uber_df, x="Type", y="Cost", color="City", markers=True, 
              title="It is cheaper to take Uber than own a car in four of the five largest U.S. cities.")
...
pio.show(fig)  # Use this instead of fig.show()
...
fig = px.line(uber_df, x="Type", y="Cost", color="City", markers=True, 
              title="It is cheaper to take Uber than own a car in four of the\nfive largest U.S. cities.",
