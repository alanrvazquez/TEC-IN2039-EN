...
slp_plot = slp_plot + geom_line(size = 2, alpha = 0.5) 
slp_plot = slp_plot + geom_point(size = 3)
slp_plot = slp_plot + labs(title = "It is cheaper to take Uber than own a car in four of the five largest U.S. cities.", x = "", y = "Costo (USD)", color = "City")
...
## Three Components of a Data Story
...
::: incremental
1.  **Avoid jargon overload.** Speak in plain, everyday language your audience understands.

2.  **Develop the main objective** Start your speech with "By \[insert what you want to accomplish\] you will \[insert what your listener wants\]."

3.  **Present the “so what.”** Don’t dive straight into details — explain *why it matters* first.
...
8.  **End with a call to action.** Tell your audience *what you want them to do next.*
:::

## Take-Home Activity

Prepare a short presentation (up to 5 minutes) about any topic you’re passionate about.

**Guidelines**:

-   Use slides (PowerPoint or Google Slides — your choice).\
